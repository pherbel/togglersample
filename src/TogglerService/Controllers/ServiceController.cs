namespace TogglerService.Controllers
{
    ...
    public class ServiceController : ControllerBase
    {
        ...
        /// invalid.</returns>
        [HttpPost("", Name = TogglesControllerRoute.PostServiceToggle)]
        [SwaggerResponse(StatusCodes.Status201Created, "The Service toggle was created.", typeof(ToggleVM))]
        ...
        /// </returns>
        [HttpGet("", Name = TogglesControllerRoute.GetServiceTogglesList)]
        [HttpHead("", Name = TogglesControllerRoute.HeadServiceTogglesList)]
        [SwaggerResponse(StatusCodes.Status200OK, "A collection of Service toggles for the specified page.", typeof(List<ToggleVM>))]
...
#pragma warning restore CA1801 // Naming Styles
        ...
        [HttpDelete("{toggleId}", Name = TogglesControllerRoute.DeleteServiceToggle)]
        ...
        /// <returns>A 204 No Content response if the Service toggle was deleted or a 404 Not Found if a Service toggle with the specified
        /// unique identifier was not found.</returns>
        [HttpGet("{toggleId}", Name = TogglesControllerRoute.GetServiceToggle)]
        [HttpHead("{toggleId}", Name = TogglesControllerRoute.HeadServiceToggle)]
        [SwaggerResponse(StatusCodes.Status200OK, "The Service toggle with the specified unique identifier.", typeof(ToggleVM))]
        ...
        [HttpPut("{toggleId}", Name = TogglesControllerRoute.PutServiceToggle)]
        ...
        public Task<IActionResult> Put(
            ...
            CancellationToken cancellationToken)
        {
            return command.ExecuteAsync(toggleId, ServiceToggle, cancellationToken);
        }
    }
}
